import { ControlType as e, addPropertyControls as t } from "framer";
...
function s({ embedUrl: e, style: t }) {
	return e ? /* @__PURE__ */ (0, o.jsx)("iframe", {
		src: e,
		style: {
			...t,
			border: "none",
		...
		children: "No booking URL configured"
	});
}
t(s, {
	embedUrl: {
...
//#endregion
export { s as BookingForm, s as default };
